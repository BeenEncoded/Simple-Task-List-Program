...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tasks: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tasks ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/common.o: common.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common.o common.cpp

${OBJECTDIR}/date_class.o: date_class.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/date_class.o date_class.cpp

${OBJECTDIR}/filesystem.o: filesystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filesystem.o filesystem.cpp

${OBJECTDIR}/iofunctions.o: iofunctions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iofunctions.o iofunctions.cpp
...
${OBJECTDIR}/scroll_display.o: scroll_display.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scroll_display.o scroll_display.cpp

${OBJECTDIR}/task_class.o: task_class.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/task_class.o task_class.cpp

${OBJECTDIR}/task_list_menu.o: task_list_menu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/task_list_menu.o task_list_menu.cpp

${OBJECTDIR}/tasklist_menu_date_view.o: tasklist_menu_date_view.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tasklist_menu_date_view.o tasklist_menu_date_view.cpp

${OBJECTDIR}/tasklist_menu_globals.o: tasklist_menu_globals.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tasklist_menu_globals.o tasklist_menu_globals.cpp

${OBJECTDIR}/tasklist_menu_list_view.o: tasklist_menu_list_view.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tasklist_menu_list_view.o tasklist_menu_list_view.cpp

${OBJECTDIR}/tasklist_menu_sorting.o: tasklist_menu_sorting.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tasklist_menu_sorting.o tasklist_menu_sorting.cpp
