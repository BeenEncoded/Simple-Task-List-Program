...
namespace
{
    bool sort_compare(const taskList::task_class&, const taskList::task_class&, const tasklist_menu_sorting::sort_method&);
    ...
    std::function<bool(const taskList::task_class&, const taskList::task_class&)> get_compare_funct(const tasklist_menu_sorting::sort_method&);
    
    
    
    inline bool sort_compare(const taskList::task_class& task1, const taskList::task_class& task2, const tasklist_menu_sorting::sort_method& method)
    {
    ...
    inline std::function<bool(\
            ...
            const taskList::task_class&)>\
                    get_compare_funct(const tasklist_menu_sorting::sort_method& sort)
    {
